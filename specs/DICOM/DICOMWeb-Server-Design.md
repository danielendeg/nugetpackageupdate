...
## Scenarios
- A DICOMWeb implementation specified in [DICOM conformance](https://github.com/microsoft/dicom-server/blob/master/docs/users/Conformance.md) for medical Image archiving and Radiology workflow.
